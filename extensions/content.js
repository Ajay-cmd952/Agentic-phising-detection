...
function showToast(message, color = "#D4AF37") {
    ...
    activeToast.id = "agentic-toast"; // Added ID for easier tracking
...
// Kill any leftover toasts on page load
        ...
        if (activeToast) {
            ...
            if (request.shouldRedirect && request.targetUrl) {
                setTimeout(() => { 
                    ...
                    if (activeToast) activeToast.remove(); // Kill toast right before moving
    ...
    if (request.action === "analyzeScreenshot") {
        ...
        img.onload = () => {
            ...
            if (code) {
                ...
                showToast("❌ No QR detected. Try zooming in.", "#ef4444");
